...
function sosg_register_required_plugin() {
    ...
    $config = array(
        ...
        'strings'      => array(
            ...
            'notice_can_install_required'     => _n_noop( 'The SO Simple Gallery plugin requires the following plugin: %1$s.', 'The SO Simple Gallery plugin requires the following plugins: %1$s.', 'tgmpa' ), // %1$s = plugin name(s).
